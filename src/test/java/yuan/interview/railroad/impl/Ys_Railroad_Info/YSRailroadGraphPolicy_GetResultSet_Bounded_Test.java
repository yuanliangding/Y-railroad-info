...
/** 
 * @ClassName: YSRailroadGraphPolicy_GetResultSet_Bounded_Test
 * @Description:  测试YRailroadGraphPolicy类中方法calcPath中-f s，-f d相关逻辑测试
 *
 * @author 袁良锭(https://github.com/yuanliangding)
 * @date 2019年5月29日-下午5:26:57
 */
public class YSRailroadGraphPolicy_GetResultSet_Bounded_Test extends QuadGraphPolicyPrepared {
	...
	public void test() {
		...
		options3.put("e", "C");
		options3.put("M", "n30");
		List<IndividualPath> paths3 = ysRailroadGraphPolicy.getResultSet(options3);
