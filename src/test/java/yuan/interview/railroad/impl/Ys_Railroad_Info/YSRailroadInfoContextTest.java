...
/** 
 * @ClassName: YSRailroadInfoContextTest
 * @Description:  批量的命令提供给YRailroadInfoContext进行测试,通过最终输出进行效验
 *
 * @author 袁良锭(https://github.com/yuanliangding)
 * @date 2019年5月31日-下午1:45:17
 */
public class YSRailroadInfoContextTest {
	
	private YSRailroadInfoContext ysRailroadInfoContext = null;

	@Before
	public void before() {
		ysRailroadInfoContext = new YSRailroadInfoContext();
	}
	...
	public void testParser() {
		...
		ysRailroadInfoContext.start(input, output, output, null, null);
